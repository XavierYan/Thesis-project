...
def get_map_data(is_save_fig = False, is_visualize = False, is_show_vehicles = True, **kwargs):
    # xml_file_path = kwargs.get("xml_file_path", "/home/xavier/project/thesis/src/mappo/assets/cpm_lab_map.xml")
    xml_file_path = kwargs.get("xml_file_path","/home/xavier/project/thesis/trajectory_dataset_support/map/rounD/rounD_0.osm")

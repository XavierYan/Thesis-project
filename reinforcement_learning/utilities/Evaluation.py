...
class Evaluation:
    ...
    def __init__(self, model_paths, where_to_save_eva_results, models_selected = None, render_titles = None, video_save_paths = None):
        ...
        if self.num_models_selected == 10:
            ...
            self.idx_our = 0
        elif self.num_models_selected == 2:
            self.idx_our = 0
    ...
    def plot(self):
        ...
        if not self.parameters.is_save_simulation_video:
            ...
            ###############################
            data_np = self.episode_reward.cpu().numpy()
            plt.clf()
            ...
            data_np = collision_rate_sum.cpu().numpy() * 100
            data_with_agents_np = self.collision_rate_with_agents.cpu().numpy() * 100
            data_with_lanelets_np = self.collision_rate_with_lanelets.cpu().numpy() * 100
            ...
            data_np = self.distance_ref_average.cpu().numpy()
            ...
            data_np = self.velocity_average.cpu().numpy()
    ...
    def run_evaluation(self):
        ...
        for i_model in models_selected:
            ...
            self.episode_reward[i_model_selected, :len(self.saved_data.episode_reward_mean_list)] = torch.tensor([self.saved_data.episode_reward_mean_list])
...
if __name__ == "__main__":
    ...
    model_paths = [
        "/home/xavier/project/thesis/src/mappo/outputs/models/final/",
        "/home/xavier/project/thesis/src/mappo/outputs/models/no_reference/",
        "/home/xavier/project/thesis/src/mappo/outputs/models/share_extractor",
